...
const NavigationBar = () => {
  ...
  return (
    <div className="bold hover relative flex h-[5rem] w-[50rem] select-none items-center justify-between border-b border-t bg-black px-[5rem] tracking-wider">
      <CodeText text="A" />
    <div ref={initButtonRef} onMouseEnter={ButtonHovered} onMouseLeave={ButtonUnhovered}>
      <ButtonWrapper>
    ...
    <div onMouseEnter={ButtonHovered} onMouseLeave={ButtonUnhovered}>
      ...
      <motion.div className="bg-white rounded-full h-2 w-2 absolute bottom-3" animate={{left:hoveredButtonPos.left+hoveredButtonPos.width, opacity:isHovering?1: 0}} 
      transition = {isHovering?{}:{ delay:0.3}} initial={{opacity:0}}/>
    </div>
